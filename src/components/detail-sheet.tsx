...
export function DetailSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      />
      <div
        className="sheet-in relative z-10 w-full max-w-[480px] overflow-hidden rounded-t-xl px-4 pt-4 pb-[max(12px,env(safe-area-inset-bottom))]"
        style={{
          background: `linear-gradient(180deg, ${brand.color}40 0%, rgb(16 22 48 / 0.94) 46%)`,
          ...
          <>
            ...
            {more && (
              <div className="relative mt-2 grid grid-cols-2 gap-2">
                <Info label="Stato" value={statusLabel(sub.status)} />
            ...
            <div className="relative mt-3 flex items-center justify-between gap-1.5">
              <IconBtn label="Modifica" onClick={() => setEdit(true)}>
